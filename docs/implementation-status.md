...
See `docs/identity-compatibility.md` for the exact profile, updated identity path matrix and limits. General nested v1 Ability migration, reconciliation Ability dispatch and broader recovery remain open; this milestone does not claim those gates are complete. Hosted verification for this profile milestone is pending.
