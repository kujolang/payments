...
[Source/runtime-bound local lifecycle measurements](evidence/link-performance-local.json) retain the distributions, callback counts, byte sizes and exact fixture source hashes.
